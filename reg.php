...
if (isset($_POST['submit'])) {
    ...
    $sql = "insert into registration(fullname, username, email, p_number, address, password, gender, image)
    values( '$fullname', '$username', '$email', '$p_number', '$address', '$password', '$gender', '$image')";

    if (mysqli_query($conn, $sql)) {
        move_uploaded_file($tmpname, $uploc);//for adding photo
...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" >
        ...
        Have an account? <a href="log.php">Login</a><br>
        <a href="regAdmin.php">Registration as an Admin</a>
      </div>
            </form>
        </div>
    </div>
